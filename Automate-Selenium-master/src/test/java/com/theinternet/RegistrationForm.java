...
public class RegistrationForm {
	...
	public void incorrectUsernameTest() {
		...
		driver.findElement(By.name("customerName")).sendKeys("Mansi Bhagat");
		sleep(1000);
		driver.findElement(By.xpath("//*[@id=\"ap_customer_name\"]"));
		sleep(1000);
		driver.findElement(By.name("email")).sendKeys("1111111111");
		sleep(1000);
		driver.findElement(By.name("secondaryLoginClaim")).sendKeys("bmansi555777@gmail.com");
		sleep(1000);
		driver.findElement(By.name("password")).sendKeys("mansi@123");
		sleep(1000);
